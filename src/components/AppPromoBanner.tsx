...
const AppPromoBanner = () => {
  ...
  return (
    <div className="mb-8 sm:mb-16 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
      {/* Get the app */}
      <div className="rounded-2xl overflow-hidden bg-primary/5 border border-primary/10">
        <div className="flex items-center gap-6 px-6 sm:px-8 py-8 h-full">
          <div className="flex-1 min-w-0">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-2 leading-tight">
              Shop Smarter<br /><span className="text-primary">On The Go</span>
            </h2>
      ...
      {/* Sell with us */}
      <div className="rounded-2xl overflow-hidden relative bg-gradient-to-br from-slate-900 to-sky-950 text-white">
        <div
        ...
        <div className="relative z-10 px-6 sm:px-8 py-8 h-full flex flex-col justify-center">
          <p className="text-xs font-semibold tracking-wide text-sky-300 uppercase mb-2">Sell with us</p>
          <h2 className="text-2xl sm:text-3xl font-bold mb-2 leading-tight">
            Grow Your Business<br />with <span className="text-sky-300">Gadget Genie</span>
          </h2>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-white text-slate-900 rounded-lg px-5 py-2.5 text-sm font-semibold hover:bg-white/90 transition-colors w-fit"
          >
            Start Selling
