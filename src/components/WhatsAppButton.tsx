...
const WhatsAppButton = () => {
  return (
    <a
      ...
      className="fixed bottom-36 sm:bottom-20 md:bottom-6 right-4 z-40 bg-[#25D366] hover:bg-[#1ebe57] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
    >
