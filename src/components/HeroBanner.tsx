...
const HeroBanner = () => {
  ...
  const slides = [{
    ...
    bgGradient: "from-blue-700 via-blue-600 to-blue-800",
    ...
    bgGradient: "from-blue-800 via-blue-600 to-blue-700",
  ...
  const handleShopNow = (slide: any) => {
    switch (slide.category) {
      ...
      case 'phones': navigate('/phones'); toast.success(`Browsing ${slide.subtitle} deals!`); break;
  ...
  return (
    <div className="relative h-[280px] sm:h-[340px] md:h-[380px] lg:h-[420px] overflow-hidden rounded-2xl mb-6 shadow-2xl">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center h-full">
                    <div className="text-white text-center lg:text-left py-6">
                      <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 mb-4">
                        ...
                        <div className="bg-blue-400/80 text-white px-3 py-1.5 rounded-full text-xs font-bold flex items-center">
                      ...
                      <div className="mb-6">
                        <div className="flex items-center justify-center lg:justify-start gap-4 mb-2">
                          <span className="text-4xl sm:text-5xl font-black text-white drop-shadow-lg">{slide.price}</span>
                          <div className="text-left">
                            {slide.originalPrice && <div className="text-sm text-white/60 line-through">{slide.originalPrice}</div>}
                            <div className="text-xs text-blue-200 font-semibold bg-blue-500/20 px-2 py-1 rounded-full">
                      ...
                      <div className="space-y-4">
                        <Button 
                          size="lg"
                          className="bg-white text-blue-700 hover:bg-blue-50 px-8 py-4 text-lg font-bold rounded-xl shadow-2xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto min-w-[180px]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-2 text-blue-200">
                          ...
                          <span className="text-sm font-medium">{slide.validUntil}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="hidden lg:flex justify-center items-center relative">
                      <div className="relative w-full max-w-lg">
                        <div className="relative transform hover:scale-105 transition-transform duration-500">
                          ...
                          />
                          <div className="absolute -top-4 -right-4 bg-blue-400/90 backdrop-blur-sm text-white rounded-full p-3 shadow-lg animate-bounce">
      ...
      <button onClick={prevSlide} className="absolute left-3 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white rounded-full p-3 transition-all duration-200 z-20 hover:scale-110 shadow-lg">
        <ChevronLeft className="w-5 h-5" />
      </button>
      <button onClick={nextSlide} className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white rounded-full p-3 transition-all duration-200 z-20 hover:scale-110 shadow-lg">
