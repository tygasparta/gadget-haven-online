...
const BotDashboardTab = () => {
  ...
  const testBot = async () => {
    // This is a placeholder for bot testing functionality
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{loading ? '...' : botStats.activeConversations}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{loading ? '...' : botStats.totalMessages}</p>
              </div>
