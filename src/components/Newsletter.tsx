...
const Newsletter = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-indigo-100 py-16 lg:py-24">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-16 -left-16 w-32 h-32 bg-indigo-200/30 rounded-full animate-pulse"></div>
        <div className="absolute top-1/4 right-10 w-20 h-20 bg-indigo-300/20 rounded-full animate-bounce"></div>
        <div className="absolute bottom-10 left-1/4 w-24 h-24 bg-indigo-400/20 rounded-full animate-ping"></div>
        <div className="absolute top-1/2 right-1/4 w-16 h-16 bg-indigo-500/20 rounded-full animate-pulse"></div>
      </div>

      <div className="max-w-7xl mx-auto px-4 relative z-10">
        {/* Main Content */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-full mb-6 shadow-xl">
            <Mail className="w-10 h-10 text-white" />
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Join Our <span className="text-indigo-600">Tech Community</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-indigo-100">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-indigo-100">
            <div className="bg-gradient-to-br from-indigo-700 to-indigo-800 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-indigo-100">
            <div className="bg-gradient-to-br from-indigo-800 to-indigo-900 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
        ...
        <div className="max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 shadow-2xl border border-indigo-200">
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                <Input
                  ...
                  className="h-14 px-6 text-lg border-2 border-gray-200 rounded-2xl focus:border-indigo-500 focus:ring-indigo-500"
                  required
                />
              </div>
              <Button 
                type="submit"
                className="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white px-8 py-4 h-14 text-lg font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
              >
                Subscribe Now
              </Button>
            </div>
