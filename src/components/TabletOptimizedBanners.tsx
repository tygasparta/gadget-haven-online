...
import { Gift, Zap, Trophy, Star, Crown, TrendingUp, Percent, Tag, Sparkles, Timer } from 'lucide-react';
...
const TabletOptimizedBanners = () => {
  return (
    <div className="hidden md:block lg:hidden">
      {/* Tablet Hero Banner */}
      <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-6 mb-6 overflow-hidden">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-gold-500 to-amber-600 rounded-xl p-4 text-white relative overflow-hidden">
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
        ...
        <div className="grid grid-cols-4 gap-3">
          {[
            { name: 'Smartphones', icon: '📱', color: 'bg-blue-100 text-blue-600' },
            { name: 'Laptops', icon: '💻', color: 'bg-purple-100 text-purple-600' },
            { name: 'Audio', icon: '🎧', color: 'bg-pink-100 text-pink-600' },
            { name: 'Gaming', icon: '🎮', color: 'bg-green-100 text-green-600' }
          ].map((category) => (
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl p-4 text-white mb-6">
